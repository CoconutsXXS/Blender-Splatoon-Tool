bl_info = {
    ...
    "version": (1, 0),
    "blender": (2, 80, 0),
    "location": "File > Import > Splatoon Item",
    "description": "Recreate all types of splatoon 3D model with the .fbx file and the textures like in the game",
    "warning": "",
    "doc_url": "",
    "category": "Import",
}
            ...
            for img_path in path_iterator( path ):
                if img_path.lower().startswith(base_name.lower()+"_"):
                    ...
                    if img_path.endswith("alb.png"):
                        ...
                        alb_node = img_node
                        links.new(img_node.outputs[1], bsdf.inputs[21])
...
def menu_func_import(self, context):
    self.layout.operator(import_splatoon_item.bl_idname, text="Splatoon Item")
