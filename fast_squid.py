bl_info = {
    ...
    "version": (1, 0),
    "blender": (2, 80, 0),
    "location": "View3D > Add > Mesh > Squid",
    "description": "Create a procedural Squid in few clicks.",
    "warning": "",
    "doc_url": "",
    "category": "Add Mesh",
}
...
def create_squid(self, context):
    ...
    src_path=str(srcPath) + "/squid.blend"
...
class OBJECT_OT_add_squid(Operator, AddObjectHelper):
    bl_idname = "mesh.squid"
    bl_label = "Add Squid"
    bl_description = "Create a procedural Squid."
    bl_options = {'REGISTER', 'UNDO'}
    
    name: bpy.props.StringProperty(
        name="Name",
        description="The squid object name",
        maxlen=50,
        default="Squid",
    )
    ink_A: FloatVectorProperty(  
       ...
       default=(1, 0, 0),
       min=0.0, max=1.0,
       description="The squid ink color"
    )
    ink_B: FloatVectorProperty(  
       ...
       default=(0, 1, 1),
       min=0.0, max=1.0,
       description="The squid enemie ink color (when he take damages)"
    )
